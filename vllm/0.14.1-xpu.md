...
* Intel® Arc™ Pro B70 support has been validated, with all models functioning properly and performance improvements observed.
...
* openbmb/MiniCPM-V-4 is not supported on B70 for vedio input in this release.
