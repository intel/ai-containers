...
The vLLM used in the this docker image is based on [v0.10.0](https://github.com/vllm-project/vllm/tree/v0.10.0)
...
* Long context optimization: The 4K and above context are significantly improved for the decoding phase by optimized flash attention kernel, up to 3.5x improvement on next token latency and 2x output throughput for 40K/512 input/output seq length for llama-70B.
