...
## Description
This guide contains instruction on how to run reference end-to-end pipeline for transfer learning with Docker container. For detailed information, go to [End-to-End Vision Transfer Learning](https://github.com/intel/vision-based-transfer-learning-and-inference) GitHub repository.

## Pull Docker Image
```
docker pull intel/vision-transfer-learning:training-ubuntu-20.04
```
...
docker run \
  ...
  --workdir /workspace \
  --privileged --init -it \
  intel/vision-transfer-learning:training-ubuntu-20.04 \
...
[Get Started Guide](https://github.com/intel-innersource/frameworks.ai.end2end-ai-pipelines.e2e-vision-transfer-learning/tree/a0205c81eb712ff94c421f4a684683bc9995cfc4)<br>

### Code Sources
[Dockerfile](https://github.com/intel-innersource/frameworks.ai.infrastructure.machine-learning-operations/blob/develop/pipelines/transfer_learning/tensorflow/resnet50/training/Dockerfile.vision-transfer-learning)<br>
